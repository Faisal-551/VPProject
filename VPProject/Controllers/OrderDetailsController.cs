...
namespace VPProject.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(VPProjectContext context)
        {
            _context = context;
        }
        ...
        {
            var vPProjectContext = _context.OrderDetail.Include(o => o.Order).Include(o => o.Product);
            return View(await vPProjectContext.ToListAsync());
        }
